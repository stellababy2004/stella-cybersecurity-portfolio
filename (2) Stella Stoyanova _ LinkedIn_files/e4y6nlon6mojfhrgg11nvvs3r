...
return i?M(i,e,n,r):g(E[T.GUEST],t)||g(E[T.MEMBER],t)||g(E[T.ENTERPRISE_UNBOUND],t)?R(_):R(w)}(e,t,r,i)},L={SHARE_DATA_WITH_TRUSTED_PARTNERS:"SHARE_DATA_WITH_TRUSTED_PARTNERS"},H=0,B=1,F=i((function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=t.guestPreferencesData,i=void 0===r?null:r,o=t.issuedAt,a=void 0===o?null:o,l=t.defaultConsent,s=void 0===l?H:l
n(this,e)
i=i||{}
this.issuedAt=a
this.guestPreferencesMap={}
for(var c in L){"number"!=typeof i[c]&&(i[c]=s)
this.guestPreferencesMap[c]=i[c]===B}})),G=(k=[L.SHARE_DATA_WITH_TRUSTED_PARTNERS],C=[H,B],{parseGuestPreferencesBody:function(e){var t=new RegExp(["^(\\d+)","(\\d+)"].join(";")),n=e.match(t)
...
return 1===n?G.parseGuestPreferencesBody(r):{error:"Invalid encoded guest preferences version ".concat(n),guestPreferences:new F}}(t):{error:null,guestPreferences:new F({defaultConsent:B})}}
